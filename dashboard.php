  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNavai()">×</a>
      ...
      <div class="navi">
        <ul>
            ...
            <li><a href="asum.php"><i class="fa fa-cog" aria-hidden="true"></i>Audio Summarisation</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-5 col-xs-12 gutter">
                            ...
                            <div class="sales">
                                ...
                                <div class="btn-group">
                                    <select class="btn btn-secondary btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <option>2019</option>
                                        <option>2018</option>
                                        <option>2017</option>
                                        <option>2016</option>
