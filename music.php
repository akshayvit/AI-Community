...
loader.load( 'exported.glb', function ( gltf ) {
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="data.php"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Data Analysis</span></a></li>
                        <li><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">IOT Products</span></a></li>
                        <li><a href="#"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Personal Assistant</span></a></li>
                    </ul>
                </div>
            </div>
