        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    ...
                    <div class="row">
                        <form id="labnol" method="POST" action="asum.php">
  <div class="speech">
    <input type="text" name="q" id="transcript" />
...
if(document.length >= 5){  return sents[0] + " - " + document[1].sentence + " - " + document[2].sentence + " - " + document[3].sentence + " - " + document[4].sentence+".");
}
else
  window.alert(document.length);
}
    ...
    if (window.hasOwnProperty('webkitSpeechRecognition')) {
      ...
      recognition.onresult = function(e) {
        document.getElementById('transcript').value
                                 = summarize(e.results[0][0].transcript);
