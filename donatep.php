  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNavai()">×</a>
      ...
      <div class="navi">
        <ul>
            ...
            <li><a href="remindo.php"><i class="fa fa-user" aria-hidden="true"></i>Remindo</a></li>
...
<body class="home">
            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-cog" aria-hidden="true"></i>IOT Products</a></li>
                        <li><a href="donatep.php"><i class="fa fa-cog" aria-hidden="true"></i>Donate Products</a></li>
                        <li><a href="buyp.php"><i class="fa fa-cog" aria-hidden="true"></i>Buy Products</a></li>
                    </ul>
                </div>
            </div>
  ...
  <div id="formContent">
    ...
    <form action="" method="POST">
      <input type="text" id="name" class="fadeIn second" name="phone" placeholder="Enter Phone">
      <input type="text" id="login" class="fadeIn second" name="email" placeholder="Email">
      <input type="text" id="password" class="fadeIn third" name="addr" placeholder="Address">
      <input type="submit" class="fadeIn" name="sub" value="Donate">
    </form>
